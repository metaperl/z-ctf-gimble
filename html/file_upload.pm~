package html::addclan;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base addclan.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/addclan.html' ;
