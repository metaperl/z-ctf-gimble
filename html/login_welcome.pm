package html::login_welcome;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base login_welcome.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/login_welcome.html' ;
