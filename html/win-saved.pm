package html::win-saved;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base win-saved.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/win-saved.html' ;
