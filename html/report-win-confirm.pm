package html::report-win-confirm;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base report-win-confirm.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/report-win-confirm.html' ;
