package html::report_match;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base report_match.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/report_match.html' ;
