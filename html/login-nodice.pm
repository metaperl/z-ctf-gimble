package html::login-nodice;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base login-nodice.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/login-nodice.html' ;
