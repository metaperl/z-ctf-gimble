package html::player_stats;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base player_stats.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/player_stats.html' ;
