package html::gimble-on-the-head;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base gimble-on-the-head.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/gimble-on-the-head.html' ;
