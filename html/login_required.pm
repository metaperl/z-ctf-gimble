package html::login_required;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base login_required.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/login_required.html' ;
