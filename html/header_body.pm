package html::header_body;

# cmdline: /afs/hcoop.net/user/t/te/terry/perl5/bin/spkg.pl --base_pkg=HTML::Seamstress::Base header_body.html
...
sub new {
#  my $file = __PACKAGE__->comp_root() . 'html/header_body.html' ;
